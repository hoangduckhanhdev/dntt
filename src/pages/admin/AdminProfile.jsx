  ...
  return (
    <div className="bg-white shadow-lg rounded-2xl p-8 max-w-3xl mx-auto mt-10 border border-orange-100">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={handleBack}
          className="flex items-center gap-1 text-gray-500 hover:text-orange-500 transition text-sm font-medium"
        >
      ...
      <form onSubmit={handleSave} className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <InputField
            ...
            icon={<User className="text-orange-400 mr-2" />}
          />
          ...
          <InputField
            ...
            icon={<Mail className="text-orange-400 mr-2" />}
          />
          ...
          <InputField
            ...
            icon={<Phone className="text-orange-400 mr-2" />}
          />
          ...
          <InputField
            ...
            icon={<Calendar className="text-orange-400 mr-2" />}
          />
        </div>
        ...
        <InputField
          ...
          icon={<MapPin className="text-orange-400 mr-2" />}
        />
        ...
        <div className="flex justify-end gap-3 pt-4">
          ...
          <button
            type="submit"
            className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2.5 rounded-xl shadow-md transition font-medium"
          >
            💾 Lưu thay đổi
          </button>
        </div>

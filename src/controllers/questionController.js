...
/**
 * Helper: lấy courseId từ param (hỗ trợ cả :id và :courseId)
 */
...
// (hoặc /api/courses/:id/questions, hoặc /api/admin/courses/:courseId/questions)
...
// POST /api/courses/:courseId/questions  (học viên đặt câu hỏi)
...
// POST /api/courses/:courseId/questions/:id/answer
// (Admin / Teacher trả lời)
